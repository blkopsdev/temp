		...
		for ($j = 0; $j < $cntTraveller; $j++) {
			...
			// if everything is ok, try to upload file
				...
				if (move_uploaded_file($_FILES['traverler']['tmp_name']['passport_photo'][$j], $passport_photo_new_name)) {
					$_POST['traverler']['passport_photo'][$j] =  get_home_url() .'/wp-content/uploads/Russia/passport_photo/'.basename($_POST['traverler']['first_name'][$j].basename($_POST['traverler']['document_number'][$j]).'.'.$passport_photo_file_name[1]);
				} else {
					$error = "Sorry, there was an error uploading your file.";
				}
			}
		...
		<div class="col-md-8 matlasform mequalheight"  id="matlascontent">
			<form method="post" class="visa_form_submit" enctype="multipart/form-data">
				...
				<div class="tourism-form"></div>
						...
						for ($j = 0; $j < $cntTraveller; $j++)
						{
							...
							<div class="travel_details_container" id="traveler_info_<?php echo $j; ?>">
								...
								<div class="form-group row">
									...
									<div class="vc_col-md-9">
										<select name="traverler[birth_country][]" id="traverler_birth_country_<?php echo $j; ?>">
											...
											if(!empty(get_list_countries())){
												foreach(get_list_countries() as $country){?>
													<option value="<?php echo $country->name;?>" <?php echo (isset($_POST['traverler']['birth_country'][$j]) == $country->name) ? 'selected' : ''; ?>><?php echo $country->name;?></option>
											<?php } } ?>
										</select>
									</div>
								</div><!-- form-group -->
								...
								<div id="russian_nationality" class="duration-9-30 hidden">
									...
									<div class="nationality_info hidden">
										<div class="form-group row">
									...
									<div class="born_russia_info hidden">
										<div class="form-group row">
								...
								<div class="alternative_name_info hidden">
									<div class="form-group row">
								...
								<div class="duration-1-8">
									<label><?php echo __( 'Are you working or studying at the moment?', 'visachild' ); ?></label>
									<div class="form-group row">
					...
					<input type="hidden" name="form_fees" value="101">
